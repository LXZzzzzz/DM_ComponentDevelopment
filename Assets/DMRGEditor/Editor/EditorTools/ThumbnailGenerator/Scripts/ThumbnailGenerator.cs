...
namespace UnityEditor.EditorTools.TLM.ThumbnailGenerator
{
    public static class ThumbnailGenerator
    {
        ...
        [MenuItem("Assets/Create/Thumbnail/Quick Generate Thumbnail &6", isValidateFunction: true, priority: 213)]
        ...
        [MenuItem("Assets/Create/Thumbnail/Quick Generate Thumbnail &6", isValidateFunction: false, priority: 213)]
        ...
        #region DMRGEditor
        public static string QuickGeneratePrefabThumbnail(UnityEngine.GameObject mPrefab)
        {
            var renderUtil = new PreviewRenderUtility();
            ...
            var instancedPrefabs = renderUtil.InstantiatePrefabInScene(mPrefab);
            ...
            var assetPathInfo = new AssetPathInfo(PrefabUtility.GetPrefabAssetPathOfNearestInstanceRoot(mPrefab), mPrefab.name, Settings.quickGenerateSuffix, AssetPathInfo.AssetType.prefab);
            var generatedAssetPath = GenerateThumbnailAssetPaths(assetPathInfo);
            ThumbnailResult result = SaveThumbnail(newTexture, generatedAssetPath);
            UnityEngine.Object.DestroyImmediate(instancedPrefabs);

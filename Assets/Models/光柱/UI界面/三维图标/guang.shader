...
Shader "Custom/guang"
{
	Properties
	{
		...
		[ASEBegin]_Color("Color 0", Color) = (0,0.6194391,1,1)
	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				float4 temp_output_13_0 = ( tex2DNode12 * _Color );
				
				float3 ase_worldNormal = packedInput.ase_texcoord2.xyz;
				float fresnelNdotV5 = dot( ase_worldNormal, V );
				float fresnelNode5 = ( _Bias + _Scale * pow( 1.0 - fresnelNdotV5, _Power ) );
				float clampResult8 = clamp( ( tex2DNode12.a * fresnelNode5 ) , 0.0 , 1.0 );
				
				surfaceDescription.Color = temp_output_13_0.rgb;
				surfaceDescription.Emission = temp_output_13_0.rgb;
				surfaceDescription.Alpha = ( ( _Color.a * _Opacity ) * clampResult8 );
        ...
        Pass
		{
					...
					)
			{
				...
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - ase_worldPos );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float fresnelNdotV5 = dot( packedInput.normalWS, ase_worldViewDir );
				float fresnelNode5 = ( _Bias + _Scale * pow( 1.0 - fresnelNdotV5, _Power ) );
				float clampResult8 = clamp( ( tex2DNode12.a * fresnelNode5 ) , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=19103
Node;AmplifyShaderEditor.RangedFloatNode;2;-1415.273,471.2755;Float;False;Property;_Bias;Bias;2;0;Create;True;0;0;0;False;0;False;0;-0.27;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;3;-1462.273,562.2756;Float;False;Property;_Scale;Scale;3;0;Create;True;0;0;0;False;0;False;1;0.15;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;4;-1396.273,656.2756;Float;False;Property;_Power;Power;4;0;Create;True;0;0;0;False;0;False;5;2.89;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FresnelNode;5;-1183.772,392.1699;Inherit;True;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;12;-1052.259,-149.4367;Inherit;True;Property;_Texture;Texture;5;0;Create;True;0;0;0;False;0;False;-1;09b03bd943223d44d88784ec28c587d6;09b03bd943223d44d88784ec28c587d6;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;7;-741.0725,379.27;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;6;-1016.533,68.87319;Float;False;Property;_Color;Color 0;0;0;Create;True;0;0;0;False;0;False;0,0.6194391,1,1;0,0.7389381,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;16;-1056.332,283.3991;Float;False;Property;_Opacity;Opacity ;1;0;Create;True;0;0;0;False;0;False;0.2;0.25;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;8;-465.0059,306.3425;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;17;-698.332,254.3991;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;-507.259,136.5633;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-232.6474,213.9427;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;18;0,0;Float;False;True;-1;2;Rendering.HighDefinition.HDUnlitGUI;0;13;Custom/guang;7f5cb9c3ea6481f469fdd856555439ef;True;Forward Unlit;0;0;Forward Unlit;9;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Transparent=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;True;1;0;True;_SrcBlend;0;True;_DstBlend;1;0;True;_AlphaSrcBlend;0;True;_AlphaDstBlend;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;_CullModeForward;False;False;False;True;True;True;True;True;0;True;_ColorMaskTransparentVel;False;False;False;False;False;True;True;0;True;_StencilRef;255;False;;255;True;_StencilWriteMask;7;False;;3;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;0;True;_ZWrite;True;0;True;_ZTestDepthEqualForOpaque;False;True;1;LightMode=ForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;30;Surface Type;1;638526521763467205;  Rendering Pass ;0;0;  Rendering Pass;1;0;  Blending Mode;0;0;  Receive Fog;1;0;  Distortion;0;0;    Distortion Mode;0;0;    Distortion Only;1;0;  Depth Write;1;0;  Cull Mode;0;0;  Depth Test;4;0;Double-Sided;1;638526521799480526;Alpha Clipping;0;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;Shadow Matte;0;0;Cast Shadows;1;0;DOTS Instancing;0;0;GPU Instancing;1;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;LOD CrossFade;0;0;0;8;True;True;True;True;True;True;False;True;False;;False;0
...
ASEEND*/
//CHKSM=441A435E058BE613CA0D0C79C67D8FF6673718F5
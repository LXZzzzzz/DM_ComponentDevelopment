...
public class HospitalMain : ScriptManager
{
    ...
    public override void RunModeInitialized(bool isRoomCreator, SceneInfo info)
    {
        ...
        rsl.Init(BObjectId, 3, (Properties[0] as InputFloatUnitProperty).Value, (Properties[1] as InputIntUnitProperty).Value, (Properties[3] as InputStringProperty).Value);
